...
let logdata = {
    ...
    const table_info = stmt.run(String(logdata.remoteaddr), logdata.remoteuser, logdata.time, String(logdata.method), String(logdata.url), String(logdata.protocol), String(logdata.httpversion), logdata.status, String(logdata.referer), String(logdata.useragent));
    next();
});
